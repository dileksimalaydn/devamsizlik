        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="text-base font-bold text-slate-900">
              {course.courseName} <span className="text-slate-400">•</span> {course.blocks} blok
            </div>
            ...
            {missed > 0 ? (
              <div className="mt-2 text-sm font-semibold text-rose-600">
                Seçim: {missed} saat gelmedin
              </div>
            ) : (
              <div className="mt-2 text-sm text-slate-500">Henüz işaretlenmedi</div>
            )}
          </div>
        </div>
