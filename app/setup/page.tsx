...
export default function SetupPage() {
  ...
  // ✅ Ortak, okunaklı ama “simsiyah olmayan” input stili
  const field =
      ...
      <div className="mx-auto max-w-md px-4 pt-4">
        <div className="rounded-3xl bg-white p-4 shadow-sm border border-slate-100">
          ...
          <div className="mt-4 space-y-3">
            ...
            <button
              onClick={handleSave}
              className="w-full rounded-2xl bg-slate-900 py-3 text-sm font-semibold text-white hover:bg-slate-800 transition"
            >
              Kaydet
            </button>
