    ...
    <div className="min-h-screen bg-background text-muted-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 space-y-10">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-extrabold text-foreground">Kişisel Verilerin Korunması Kanunu Kapsamında Aydınlatma Metni</h1>
          <p className="text-muted-foreground text-sm">6698 Sayılı Kişisel Verilerin Korunması Kanunu Uyarınca Hazırlanmıştır</p>
          <p className="text-muted-foreground text-sm">Son güncelleme: Mart 2026</p>
        </div>

        <div className="bg-card border border-border rounded-2xl p-5 text-sm leading-relaxed text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">1. Veri Sorumlusunun Kimliği ve İletişim Bilgileri</h2>
          <div className="space-y-2 text-sm leading-relaxed">
            <p><span className="text-muted-foreground font-semibold">Veri Sorumlusu:</span> <span className="text-foreground">devamsızlık platformu</span></p>
            <p><span className="text-muted-foreground font-semibold">Uygulama Adı:</span> <span className="text-foreground">devamsızlık (devamsizlik.com)</span></p>
            <p><span className="text-muted-foreground font-semibold">İletişim E-postası:</span>{" "}
              <a href="mailto:devamsizlik.iletisim@gmail.com" className="text-primary hover:underline">devamsizlik.iletisim@gmail.com</a>
            </p>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">2. İşlenen Kişisel Verilerin Kategorileri</h2>
          <p className="text-sm text-muted-foreground">Uygulamamız aracılığıyla aşağıdaki kişisel veri kategorileri işlenmektedir:</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border border-border rounded-xl overflow-hidden">
              <thead>
                <tr className="bg-card text-muted-foreground">
                  <th className="text-left px-4 py-3 font-semibold border-b border-border">Veri Kategorisi</th>
                  <th className="text-left px-4 py-3 font-semibold border-b border-border">Verinin İçeriği</th>
                  <th className="text-left px-4 py-3 font-semibold border-b border-border">Nitelik</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border">
                <tr className="bg-background">
                  <td className="px-4 py-3 text-foreground font-medium">Kimlik Verisi</td>
                  <td className="px-4 py-3 text-muted-foreground">E-posta adresi</td>
                  <td className="px-4 py-3 text-muted-foreground">Zorunlu</td>
                </tr>
                <tr className="bg-card/40">
                  <td className="px-4 py-3 text-foreground font-medium">İşlem Güvenliği Verisi</td>
                  <td className="px-4 py-3 text-muted-foreground">Giriş tarihi, son oturum bilgisi, şifrelenmiş parola</td>
                  <td className="px-4 py-3 text-muted-foreground">Zorunlu</td>
                </tr>
                <tr className="bg-background">
                  <td className="px-4 py-3 text-foreground font-medium">Kullanıcı İçerik Verisi</td>
                  <td className="px-4 py-3 text-muted-foreground">Ders adları, ders günleri ve saatleri, devamsızlık kayıtları, kullanıcının okuduğu okul</td>
                  <td className="px-4 py-3 text-muted-foreground">Kullanıcı tarafından girilir</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-xs text-muted-foreground mt-2">
            TC kimlik numarası, telefon numarası, adres, kredi kartı bilgisi, sağlık verisi veya özel nitelikli kişisel veri niteliğinde herhangi bir bilgi <strong className="text-foreground">kesinlikle toplanmamaktadır</strong>.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">3. Kişisel Verilerin İşlenme Amaçları ve Hukuki Dayanakları</h2>
          <div className="space-y-4 text-sm">
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">3.1. Sözleşmenin Kurulması ve İfası (KVKK Madde 5/2-c)</p>
            ...
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">3.2. Meşru Menfaat (KVKK Madde 5/2-f)</p>
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
            ...
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">3.3. Açık Rıza (KVKK Madde 5/1)</p>
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">4. Kişisel Verilerin Aktarıldığı Taraflar ve Aktarım Amaçları</h2>
          <p className="text-sm text-muted-foreground">Kişisel verileriniz; ticari amaçla üçüncü taraflarla paylaşılmamakta, satılmamakta veya kiralanmamaktadır. Yalnızca hizmetin sunulması için zorunlu teknik altyapı sağlayıcılarına, KVKK'nın 8. ve 9. maddeleri kapsamında aktarılmaktadır:</p>
          <div className="space-y-3">
            {[
              ...
              <div key={p.name} className="bg-card border border-border rounded-xl p-4 text-sm space-y-1">
                <p className="text-foreground font-semibold">{p.name}</p>
                <p><span className="text-muted-foreground">Amaç:</span> <span className="text-muted-foreground">{p.purpose}</span></p>
                <p><span className="text-muted-foreground">Konum:</span> <span className="text-muted-foreground">{p.location}</span></p>
                <p><span className="text-muted-foreground">Aktarılan veri:</span> <span className="text-muted-foreground">{p.data}</span></p>
                <p><span className="text-muted-foreground">Hukuki dayanak:</span> <span className="text-muted-foreground">{p.basis}</span></p>
              </div>
            ))}
          </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">5. Kişisel Verilerin Toplanma Yöntemi</h2>
          <p className="text-sm leading-relaxed text-muted-foreground">
            Kişisel verileriniz; uygulamamızın kayıt ve giriş formları, Google OAuth kimlik doğrulama servisi ve kullanıcının uygulama içinde bizzat girdiği içerikler aracılığıyla <strong className="text-foreground">elektronik ortamda otomatik yöntemlerle</strong> toplanmaktadır. Verileriniz yalnızca yukarıda belirtilen hukuki dayanaklar çerçevesinde ve bu metinde açıklanan amaçlarla sınırlı olarak işlenmektedir.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">6. Kişisel Verilerin Saklanma Süresi</h2>
          <div className="space-y-3 text-sm">
            <div className="overflow-x-auto">
              <table className="w-full border border-border rounded-xl overflow-hidden">
                <thead>
                  <tr className="bg-card text-muted-foreground">
                    <th className="text-left px-4 py-3 font-semibold border-b border-border">Veri Türü</th>
                    <th className="text-left px-4 py-3 font-semibold border-b border-border">Saklama Süresi</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  <tr className="bg-background">
                    <td className="px-4 py-3 text-foreground">Hesap ve kimlik doğrulama verileri</td>
                    <td className="px-4 py-3 text-muted-foreground">Hesap aktif olduğu sürece; hesap silinme talebi üzerine işlenme amacı ortadan kalktığında makul süre içinde silinir. Yedekleme sistemleri nedeniyle kalıcı silme belirli bir süre alabilir.</td>
                  </tr>
                  <tr className="bg-card/40">
                    <td className="px-4 py-3 text-foreground">Ders ve devamsızlık verileri</td>
                    <td className="px-4 py-3 text-muted-foreground">Hesap aktif olduğu sürece; silme talebi halinde işlenme amacı ortadan kalktığında makul süre içinde silinir.</td>
                  </tr>
                  <tr className="bg-background">
                    <td className="px-4 py-3 text-foreground">E-posta bildirim logları</td>
                    <td className="px-4 py-3 text-muted-foreground">Hizmet sağlayıcının (Resend) teknik gereklilikleri kapsamında sınırlı süre; işlenme amacının ortadan kalkmasıyla silinir.</td>
                  </tr>
                  <tr className="bg-card/40">
                    <td className="px-4 py-3 text-foreground">Erişim ve işlem logları</td>
                    <td className="px-4 py-3 text-muted-foreground">Yasal yükümlülük kapsamında azami 2 yıl</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">7. Veri Sahibi Olarak Haklarınız (KVKK Madde 11)</h2>
          <p className="text-sm text-muted-foreground">6698 sayılı KVKK'nın 11. maddesi uyarınca kişisel verilerinize ilişkin aşağıdaki haklara sahipsiniz:</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item.hak} className="bg-card border border-border rounded-xl p-3 text-sm">
                <p className="text-foreground font-semibold mb-1">{item.hak}</p>
                <p className="text-muted-foreground text-xs">{item.aciklama}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">8. Başvuru Yöntemi</h2>
          <div className="bg-card border border-primary/30 rounded-xl p-5 text-sm space-y-3">
            <p className="text-muted-foreground leading-relaxed">
              KVKK Madde 11 kapsamındaki haklarınızı kullanmak için aşağıdaki yöntemi kullanabilirsiniz:
            </p>
            <div className="space-y-2">
              <p><span className="text-muted-foreground font-semibold">E-posta ile başvuru:</span>{" "}
                <a href="mailto:devamsizlik.iletisim@gmail.com" className="text-primary hover:underline font-medium">devamsizlik.iletisim@gmail.com</a>
              </p>
              <p className="text-muted-foreground text-xs">E-posta konusuna <strong className="text-muted-foreground">"KVKK Veri Sahibi Başvurusu"</strong> yazınız. Başvurunuzda; adınız-soyadınız, e-posta adresiniz, kullandığınız hak ve talebinizin açık ifadesi yer almalıdır.</p>
            </div>
            <p className="text-muted-foreground text-xs leading-relaxed">
              Başvurunuz, KVKK'nın 13. maddesi uyarınca talebin niteliğine göre en geç <strong className="text-foreground">otuz (30) gün</strong> içinde ücretsiz olarak sonuçlandırılacaktır. Talebin ayrıca bir maliyet gerektirmesi halinde Kişisel Verileri Koruma Kurulu tarafından belirlenen tarifedeki ücret alınabilir.
            </p>
            <p className="text-muted-foreground text-xs">
              Başvurunuzun reddedilmesi, verilen cevabın yetersiz bulunması veya süresinde cevap verilmemesi hallerinde; cevabı öğrendiğiniz tarihten itibaren <strong className="text-foreground">otuz (30)</strong> ve her hâlde başvuru tarihinden itibaren <strong className="text-foreground">altmış (60)</strong> gün içinde Kişisel Verileri Koruma Kurulu'na şikâyette bulunma hakkınız mevcuttur.
            </p>
          </div>
        </section>

        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">9. Güvenlik Önlemleri</h2>
          <p className="text-sm leading-relaxed text-muted-foreground">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-amber-950/40 border border-amber-800/50 rounded-2xl p-5 text-sm space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              ...
              <li>Uygulamanın sunduğu devamsızlık hesaplamaları (limit, yüzde vb.) <strong className="text-foreground">tahmini ve bilgilendirici nitelikte</strong> olup bağlı olduğunuz kurumun resmi mevzuatı esas alınmalıdır.</li>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">11. Kullanıcı Sorumluluğu</h2>
          ...
          <div className="space-y-3 text-sm">
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">11.1. Veri Doğruluğu</p>
              <p className="text-muted-foreground leading-relaxed">Uygulamaya girilen tüm veriler (ders adları, saatler, devamsızlık kayıtları vb.) yalnızca kullanıcı tarafından girilmektedir. Bu verilerin doğruluğu, eksiksizliği ve güncelliğinden münhasıran kullanıcı sorumludur. Veri sorumlusu, kullanıcının yanlış veya eksik girdiği bilgilerden doğabilecek herhangi bir sonuçtan sorumlu tutulamaz.</p>
            </div>
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">11.2. Hesap Güvenliği</p>
              <p className="text-muted-foreground leading-relaxed">Kullanıcı; hesap şifresinin gizliliğini korumak, güçlü ve benzersiz bir şifre seçmek, oturumunu üçüncü şahıslarla paylaşmamak ve hesabına yetkisiz erişim fark ettiğinde derhal şifresini değiştirmekle yükümlüdür. Kullanıcının şifresini paylaşması, zayıf şifre kullanması veya kendi cihazından kaynaklanan güvenlik açıkları nedeniyle oluşacak zararlardan veri sorumlusu sorumlu değildir.</p>
            </div>
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">11.3. Kullanım Amacı ve Yasal Uyum</p>
              <p className="text-muted-foreground leading-relaxed">Kullanıcı, uygulamayı yalnızca kişisel devamsızlık takibi amacıyla, yasalara ve bu Aydınlatma Metni'ne uygun şekilde kullanacağını kabul eder. Uygulamanın kötüye kullanımından, başkalarının verilerine izinsiz erişim girişimlerinden ve üçüncü kişilere zarar verebilecek her türlü eylemden münhasıren kullanıcı sorumludur.</p>
            </div>
          </div>
        </section>

        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">12. Sorumluluğun Sınırlandırılması</h2>
          <div className="space-y-3 text-sm">
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">12.1. Hizmetin "Olduğu Gibi" Sunulması</p>
              <p className="text-muted-foreground leading-relaxed">Uygulama, ticari bir ürün değil bireysel bir geliştirici tarafından sunulan bağımsız bir hizmet olarak <strong className="text-foreground">"olduğu gibi" (as-is)</strong> sunulmaktadır. Hizmet kesintileri, teknik arızalar, veri kaybı veya sistemdeki hatalardan kaynaklanan doğrudan ya da dolaylı zararlardan veri sorumlusunun sorumluluğu, yürürlükteki mevzuatın izin verdiği azami ölçüde sınırlandırılmıştır.</p>
            </div>
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">12.2. Güvenlik İhlali Riski ve Kabul</p>
              <p className="text-muted-foreground leading-relaxed">
                Veri sorumlusu, kişisel verilerin güvenliğini sağlamak için KVKK'nın 12. maddesi kapsamında makul teknik ve idari tedbirler almaktadır. Bununla birlikte, hiçbir teknik sistem %100 güvenlik garantisi sunamamaktadır. Kullanıcı; uygulamaya kaydolarak ve bu Aydınlatma Metni'ni onaylayarak, <strong className="text-foreground">olası bir güvenlik ihlali durumunda sistemde kayıtlı e-posta adresinin üçüncü kişilerin eline geçebileceği riskini bilerek ve açık rızasıyla</strong> kabul etmektedir.
              </p>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card border border-border rounded-xl p-4 space-y-2">
              <p className="text-foreground font-semibold">12.3. Üçüncü Taraf Altyapısından Kaynaklanan Riskler</p>
              <p className="text-muted-foreground leading-relaxed">Uygulama; Supabase, Vercel, Resend ve Cloudflare gibi üçüncü taraf altyapı sağlayıcılarını kullanmaktadır. Bu sağlayıcıların kendi sistemlerinde yaşanabilecek güvenlik açıkları, veri ihlalleri veya hizmet kesintilerinden doğan zararlardan veri sorumlusu sorumlu tutulamaz. Kullanıcı, bu riski bilerek hizmeti kullandığını kabul eder.</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-rose-950/40 border border-rose-800/50 rounded-2xl p-5 text-sm space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-card/60 rounded-xl p-4 space-y-2">
                <p className="text-foreground font-semibold">6698 Sayılı KVKK Kapsamında İdari Yaptırımlar</p>
                <p className="text-muted-foreground">Kişisel verilere hukuka aykırı erişim; KVKK'nın 17. maddesi ve TCK'ya yapılan atıflar çerçevesinde cezai sorumluluk doğurmaktadır. Ek olarak Kişisel Verileri Koruma Kurulu tarafından idari para cezası uygulanabilir.</p>
              </div>
            </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-foreground border-b border-border pb-2">14. Politika Güncellemeleri</h2>
          <p className="text-sm leading-relaxed text-muted-foreground">
