          ...
          <div className="flex flex-col items-center gap-2">
            ...
            {onDelete && (
              <button
                ...
                className="p-2 rounded-xl bg-rose-100 dark:bg-rose-500/20 text-rose-700 dark:text-rose-300 hover:bg-rose-200 dark:hover:bg-rose-500/25 transition-colors"
                title="Dersi Sil"
              >
